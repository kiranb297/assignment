...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var capabilities, browser, page, inputText, messageText, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, page.getByRole('link', { name: 'Simple Form Demo' }).click()];
            case 4:
                _a.sent();
                return [4 /*yield*/, expect(page.url()).toContain("simple-form-demo")];
            case 5:
                _a.sent();
                inputText = "Welcome to LambdaTest";
                return [4 /*yield*/, page.getByPlaceholder('Please enter your Message').fill(inputText)];
            case 6:
                _a.sent();
                return [4 /*yield*/, page.locator('//button[@id="showInput"]').click()];
            case 7:
                _a.sent();
                return [4 /*yield*/, page.waitForSelector('//p[@id="message"]')];
            case 8:
                _a.sent();
                return [4 /*yield*/, page.locator('//p[@id="message"]').textContent()];
            case 9:
                messageText = _a.sent();
                _a.label = 10;
            case 10:
                _a.trys.push([10, 13, , 16]);
                expect(messageText).toEqual(inputText);
                // Mark the test as completed or failed
                return [4 /*yield*/, page.evaluate(function (_) { }, "lambdatest_action: ".concat(JSON.stringify({ action: 'setTestStatus', arguments: { status: 'passed', remark: 'Test scenario 1 passed' } })))];
            case 11:
                // Mark the test as completed or failed
                _a.sent();
