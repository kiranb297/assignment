...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var capabilities, browser, page, slider, target, iscompleated, movepercent, sliderBoundingBox, slidervalue, value, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, page.getByRole('link', { name: 'Drag & Drop Sliders' }).click()];
            case 4:
                _a.sent();
                return [4 /*yield*/, page.locator('#slider3').getByRole('slider')];
            case 5:
                slider = _a.sent();
                target = '95';
                iscompleated = false;
                ...
                _a.label = 6;
            case 6:
                if (!!iscompleated) return [3 /*break*/, 13];
                return [4 /*yield*/, slider.boundingBox()];
            case 7:
                sliderBoundingBox = _a.sent();
                return [4 /*yield*/, page.mouse.move(sliderBoundingBox.x + movepercent, sliderBoundingBox.y)];
            case 8:
                _a.sent();
            ...
            case 11:
                _a.sent();
                return [4 /*yield*/, page.locator('//output[@id="rangeSuccess"]').textContent()];
            case 12:
                slidervalue = _a.sent();
            ...
            case 14:
                ...
                return [4 /*yield*/, page.evaluate(function (_) { }, "lambdatest_action: ".concat(JSON.stringify({ action: 'setTestStatus', arguments: { status: 'passed', remark: 'Test scenario 2 passed' } })))];
            case 15:
                // Mark the test as completed or failed
                _a.sent();
